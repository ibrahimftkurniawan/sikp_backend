...
class App extends BaseConfig
{
     ...
     */
    public string $sessionCookieName = 'sikpbackend_session';
     ...
     */
    public string $CSRFTokenName = 'csrf_sikpbackend_name';
     ...
     */
    public string $CSRFCookieName = 'csrf_cookie_sikpbackend';
